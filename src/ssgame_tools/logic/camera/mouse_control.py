from structs.user_input.mouse.buttons_state import MouseButtonsState
from structs.camera.physics import CameraPhysicalAttributes
from structs.camera.transform import CameraTransform
from structs.camera.drag import CameraDragAttributes
from ..camera.physics import isFloating
