import pygame
from structs.user_input.mouse.callback_list import MouseCallbackList
from structs.user_input.mouse.positional_attributes import MousePositionalAttributes
